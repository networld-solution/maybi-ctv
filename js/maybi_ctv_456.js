const MaybiRegistration = {
    googleScriptUrl: 'THAY_LINK_GOOGLE_APP_SCRIPT_CUA_BAN_VAO_DAY',
    ...
    handleSubmit: function(e) {
        ...
        const phone = this.form.querySelector('[name="so_dien_thoai"]').value.trim();
        ...
        .then(() => {
            alert('Đăng ký thành công! MAYBI sẽ liên hệ với bạn trong thời gian sớm nhất.');
            this.form.reset();
        })
        .catch((error) => {
